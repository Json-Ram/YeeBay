        ...
        <div className="flex items-center justify-between w-full mx-auto max-w-[1200px]">
          <div className="flex items-center w-full bg-white">
            <div className="flex lg:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto">
              <Link href="/">
                <img width="160" src="/images/yeebay.png" />
              </Link>

              <div className="w-full">
                <div className="relative">
                  <div className="flex items-center">
                    <div className="relative flex items-center border-2 border-gray-900 rounded-lg w-full p-2">
                    ...
                    <button className="flex items-center bg-blue-600 rounded-lg text-sm font-semibold text-white p-[11px] ml-2 px-14">
                      Search
                    </button>
